...
internal class Calendar {
    ...
    public Calendar(IReadOnlyList<IReadOnlyList<CalendarToken>> lines)
    {
        Lines = lines;
    }

    public IReadOnlyList<IReadOnlyList<CalendarToken>> Lines { get; }

    public static Calendar Parse(int year, IDocument document) {

        var theme = new Dictionary<string[], int>();

        // anglesharp bug, it doesn't handle external stylesheets well.
        ...
        return new Calendar(lines) { Year = year, Theme = theme };
    }
