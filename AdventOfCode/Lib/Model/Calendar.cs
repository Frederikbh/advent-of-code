...
public class CalendarToken
{
    ...
    public string RgbaColor { get; set; } = null!;
...
public class Calendar
{
    ...
    public IReadOnlyList<IReadOnlyList<CalendarToken>> Lines { get; private init; } = new List<List<CalendarToken>>();
