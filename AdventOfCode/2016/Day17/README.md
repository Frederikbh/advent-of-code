...
For example:
 ...
 - If your passcode were <code>ihgpwlah</code>, the longest path would take <code>370</code> steps.
 - With <code>kglvqrro</code>, the longest path would be <code>492</code> steps long.
 - With <code>ulqzkmiv</code>, the longest path would be <code>830</code> steps long.



What is the <em>length of the longest path</em> that reaches the vault?
